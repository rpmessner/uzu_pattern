defmodule UzuPattern.Pattern do
  ...
  ## Examples
      ...
      iex> pattern = Pattern.new("bd sd hh cp") |> Pattern.euclid(3, 8)
      iex> events = Pattern.events(pattern)
      iex> length(events) == 3
      true
  """
  ...
  ## Examples
      ...
      iex> pattern = Pattern.new("bd sd hh cp") |> Pattern.euclid_rot(3, 8, 2)
      iex> events = Pattern.events(pattern)
      iex> length(events) == 3
      true
  """
  ...
  ## Examples
      ...
      iex> pattern = Pattern.new("hh*8") |> Pattern.swing(4)
      iex> events = Pattern.events(pattern)
      iex> length(events) == 8
      true
  """
  ...
  ## Examples
      ...
      iex> pattern = Pattern.new("hh*8") |> Pattern.swing_by(0.5, 4)
      iex> events = Pattern.events(pattern)
      iex> length(events) == 8
      true
  """
  ...
  ## Examples
      ...
      iex> pattern = Pattern.new("bd sd hh") |> Pattern.gain(0.5)
      iex> events = Pattern.events(pattern)
      iex> Enum.all?(events, fn e -> e.params[:gain] == 0.5 end)
      true
  """
  def gain(%__MODULE__{} = pattern, value) when is_number(value) do
  ...
  ## Examples
      ...
      iex> pattern = Pattern.new("bd sd") |> Pattern.pan(0.5)
      iex> events = Pattern.events(pattern)
      iex> Enum.all?(events, fn e -> e.params[:pan] == 0.5 end)
      true
  """
  def pan(%__MODULE__{} = pattern, value) when is_number(value) and value >= 0.0 and value <= 1.0 do
  ...
  ## Examples
      ...
      iex> pattern = Pattern.new("bd sd") |> Pattern.speed(2.0)
      iex> events = Pattern.events(pattern)
      iex> Enum.all?(events, fn e -> e.params[:speed] == 2.0 end)
      true
  """
  def speed(%__MODULE__{} = pattern, value) when is_number(value) and value > 0.0 do
  ...
  ## Examples
      ...
      iex> pattern = Pattern.new("bd sd") |> Pattern.cut(1)
      iex> events = Pattern.events(pattern)
      iex> Enum.all?(events, fn e -> e.params[:cut] == 1 end)
      true
  """
  def cut(%__MODULE__{} = pattern, group) when is_integer(group) and group >= 0 do
  ...
  ## Examples
      ...
      iex> pattern = Pattern.new("bd sd") |> Pattern.room(0.5)
      iex> events = Pattern.events(pattern)
      iex> Enum.all?(events, fn e -> e.params[:room] == 0.5 end)
      true
  """
  def room(%__MODULE__{} = pattern, value) when is_number(value) and value >= 0.0 and value <= 1.0 do
  ...
  ## Examples
      ...
      iex> pattern = Pattern.new("bd sd") |> Pattern.delay(0.25)
      iex> events = Pattern.events(pattern)
      iex> Enum.all?(events, fn e -> e.params[:delay] == 0.25 end)
      true
  """
  def delay(%__MODULE__{} = pattern, value) when is_number(value) and value >= 0.0 and value <= 1.0 do
  ...
  ## Examples
      ...
      iex> pattern = Pattern.new("bd sd") |> Pattern.lpf(1000)
      iex> events = Pattern.events(pattern)
      iex> Enum.all?(events, fn e -> e.params[:lpf] == 1000 end)
      true
  """
  def lpf(%__MODULE__{} = pattern, frequency) when is_number(frequency) and frequency >= 0 and frequency <= 20000 do
  ...
  ## Examples
      ...
      iex> pattern = Pattern.new("bd sd") |> Pattern.hpf(1000)
      iex> events = Pattern.events(pattern)
      iex> Enum.all?(events, fn e -> e.params[:hpf] == 1000 end)
      true
  """
  def hpf(%__MODULE__{} = pattern, frequency) when is_number(frequency) and frequency >= 0 and frequency <= 20000 do
